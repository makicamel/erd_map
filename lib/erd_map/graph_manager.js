class GraphManager {
  ...
  #applyDisplayTitleMode() {
    ...
    if (this.#showTitleMode) {
      this.plot.remove_layout(this.nodeLabels.foreignModelLabel)
      this.plot.remove_layout(this.nodeLabels.foreignColumnsLabel)
      this.plot.add_layout(this.nodeLabels.titleModelLabel)
    } else {
      this.plot.remove_layout(this.nodeLabels.titleModelLabel)
      this.plot.add_layout(this.nodeLabels.foreignModelLabel)
      this.plot.add_layout(this.nodeLabels.foreignColumnsLabel)
    }
    this.plot.change.emit()
