    ...
    def js_args(plot)
      {
        ...
        searchBox: plot.header[:search_box],
        selectingNodeLabel: plot.header[:selecting_node_label],
        zoomModeToggle: plot.header[:zoom_mode_toggle],
        tapModeToggle: plot.header[:tap_mode_toggle],
        displayTitleModeToggle: plot.header[:display_title_mode_toggle],
        nodeLabels: {
